...
{
	[AsyncMethodBuilder] // 0x000000018010C200-0x000000018010C250
	public struct UniTask<T> : IEquatable<UniRx.Async.UniTask<T>> // TypeDefIndex: 8561
	{
		// Fields
		...
		// Nested types
		private class IsCanceledAwaiter : IAwaiter<ValueTuple<bool, T>> // TypeDefIndex: 8562
		{
			// Fields
			private readonly IAwaiter<T> awaiter;
		...
		public struct Awaiter : IAwaiter<T> // TypeDefIndex: 8563
		{
			// Fields
