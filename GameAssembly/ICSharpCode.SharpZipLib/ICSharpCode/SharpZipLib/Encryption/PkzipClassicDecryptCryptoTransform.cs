...
{
	internal class PkzipClassicDecryptCryptoTransform : PkzipClassicCryptoBase, ICryptoTransform // TypeDefIndex: 7693
	{
		// Properties
		...
		// Constructors
		internal PkzipClassicDecryptCryptoTransform(byte[] keyBlock); // 0x0000000181EA4C10-0x0000000181EA4C40
	
		// Methods
		public byte[] TransformFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount); // 0x0000000181EA4AE0-0x0000000181EA4C10
		public int TransformBlock(byte[] inputBuffer, int inputOffset, int inputCount, byte[] outputBuffer, int outputOffset); // 0x0000000181EA49C0-0x0000000181EA4AE0
