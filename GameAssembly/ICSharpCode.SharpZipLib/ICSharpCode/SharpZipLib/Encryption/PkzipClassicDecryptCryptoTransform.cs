...
{
	internal class PkzipClassicDecryptCryptoTransform : PkzipClassicCryptoBase, ICryptoTransform // TypeDefIndex: 7527
	{
		// Properties
		...
		// Constructors
		internal PkzipClassicDecryptCryptoTransform(byte[] keyBlock); // 0x0000000180D5D3A0-0x0000000180D5D3D0
	
		// Methods
		public byte[] TransformFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount); // 0x0000000180D5D260-0x0000000180D5D3A0
		public int TransformBlock(byte[] inputBuffer, int inputOffset, int inputCount, byte[] outputBuffer, int outputOffset); // 0x0000000180D5D130-0x0000000180D5D260
