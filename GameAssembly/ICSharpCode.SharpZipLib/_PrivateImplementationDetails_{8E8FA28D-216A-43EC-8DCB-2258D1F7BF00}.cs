...
internal class <PrivateImplementationDetails>{8E8FA28D-216A-43EC-8DCB-2258D1F7BF00} // TypeDefIndex: 7736
{
	...
	internal static __StaticArrayInitTypeSize=76 $$method0x600029d-1; // 0x40C
	internal static __StaticArrayInitTypeSize=16 $$method0x600029d-2; // 0x458
	internal static __StaticArrayInitTypeSize=116 $$method0x60004fd-1; // 0x468
	internal static __StaticArrayInitTypeSize=116 $$method0x60004fd-2; // 0x4DC
	internal static __StaticArrayInitTypeSize=120 $$method0x60004fd-3; // 0x550
	internal static __StaticArrayInitTypeSize=120 $$method0x60004fd-4; // 0x5C8
	internal static __StaticArrayInitTypeSize=12 $$method0x60004fe-1; // 0x640
	internal static __StaticArrayInitTypeSize=12 $$method0x60004fe-2; // 0x64C
