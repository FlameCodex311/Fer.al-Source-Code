...
{
	[Serializable]
	public sealed class StringStringUnityEvent : UnityEvent<string, string> // TypeDefIndex: 7729
	{
		// Constructors
		public StringStringUnityEvent(); // 0x00000001822A2660-0x00000001822A26A0
	}
}
