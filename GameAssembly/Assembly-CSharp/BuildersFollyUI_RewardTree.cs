...
public class BuildersFollyUI_RewardTree : MonoBehaviour // TypeDefIndex: 10514
{
	...
	public TextMeshProUGUI tier1Text; // 0x28
	public TextMeshProUGUI tier2Text; // 0x30
	public TextMeshProUGUI tier3Text; // 0x38
	public RawImage tier1Image; // 0x40
	public RawImage tier2Image; // 0x48
	public RawImage tier3Image; // 0x50
	public GameObject chooseButton; // 0x58
	public GameObject inactive; // 0x60
