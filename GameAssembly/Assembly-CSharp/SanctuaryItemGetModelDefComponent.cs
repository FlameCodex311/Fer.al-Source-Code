...
[ChartComponent] // 0x000000018013ECD0-0x000000018013ED00
public class SanctuaryItemGetModelDefComponent : GetModelDefComponent // TypeDefIndex: 10581
{
	// Nested types
	[CompilerGenerated] // 0x00000001800B36B0-0x00000001800B36C0
	private sealed class <>c__DisplayClass0_0 // TypeDefIndex: 10582
	{
		// Fields
		...
		public SanctuaryObjectBase cSanctuaryObject; // 0x30
		...
		internal void <GetModelRoutine>b__1(GameObject inLoadedAsset); // 0x000000018036B1E0-0x000000018036B1F0
	...
	[CompilerGenerated] // 0x00000001800B36B0-0x00000001800B36C0
	private sealed class <>c__DisplayClass0_1 // TypeDefIndex: 10583
	{
		// Fields
		public int iIdx; // 0x10
		public <>c__DisplayClass0_0 CS$<>8__locals1; // 0x18
		public Action<GameObject> <>9__5; // 0x20

		// Constructors
		public <>c__DisplayClass0_1(); // 0x000000018036B6C0-0x000000018036B6D0

		// Methods
		internal void <GetModelRoutine>b__5(GameObject inLoadedAsset); // 0x0000000181379910-0x0000000181379BE0
	}

	[CompilerGenerated] // 0x00000001800B36B0-0x00000001800B36C0
	private sealed class <GetModelRoutine>d__0 : IEnumerator<object> // TypeDefIndex: 10584
	{
		// Fields
		...
		public AssetQualityLevel inQuality; // 0x40
		public BundlePriority inPriority; // 0x44
		...
		private bool MoveNext(); // 0x0000000181372C10-0x0000000181374290
		[DebuggerHidden] // 0x00000001800B36B0-0x00000001800B36C0
		void IEnumerator.Reset(); // 0x0000000181374290-0x00000001813742E0
	}

	// Constructors
	public SanctuaryItemGetModelDefComponent(); // 0x000000018128AF80-0x000000018128AF90

	// Methods
	[IteratorStateMachine] // 0x000000018013EDF0-0x000000018013EE40
	protected override IEnumerator GetModelRoutine(GameObject inTargetGameObject, Transform inParentTransform, Action<GameObject> inResult, Item inItem = null, BaseDef inDef = null, BaseInfo inInfo = null, AssetQualityLevel inQuality = AssetQualityLevel.None /* Metadata: 0x00781E30 */, BundlePriority inPriority = BundlePriority.Normal /* Metadata: 0x00781E34 */); // 0x00000001813622C0-0x0000000181362370
}
