...
public class UI_LazyListItem_TradeLobbyTheirs : UI_LazyListItem<Item> // TypeDefIndex: 13710
{
	// Fields
	...
	// Constructors
	public UI_LazyListItem_TradeLobbyTheirs(); // 0x00000001803C6E20-0x00000001803C6E60

	// Methods
	public override void Setup(Action<UI_LazyListItem<Item>> inOnClicked, Action<UI_LazyListItem<Item>> inOnSelected, Item inData, UI_LazyItemList<Item> inItemList); // 0x00000001803C6980-0x00000001803C6D30
	public override void MarkAsSelected(bool inIsSelected); // 0x00000001803774A0-0x00000001803774B0
	public void RefreshQuantity(); // 0x00000001803C6840-0x00000001803C6980
	[CompilerGenerated] // 0x00000001801CDAD0-0x00000001801CDAE0
	private void <Setup>b__7_0(); // 0x00000001803C6D30-0x00000001803C6E20
}
